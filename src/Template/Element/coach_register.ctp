...
<div class="users form large-10 medium-9 columns">
    <?= $this->Form->create($user,['url' => ['plugin' => 'CakeDC/Users','action' => 'register','coach','controller' => 'Users']]); ?>
    <fieldset>
        <legend><?= __d('CakeDC/Users', 'Register Coach') ?></legend>
        <?php
        ...
        echo $this->Form->input('group_id', ['type' => 'hidden','value'=>'coach']);

...
<div class="tab-content">
    <div role="tabpanel" class="tab-pane active" id="description">
        <div class="ed_course_tabconetent">       
            ...
            <?php if (!$url):
                echo $this->element('Sessions/cancel_session_button', ['session' => $session, 'button' => 'Cancel', 'action' => 'approvedCoach','message' => 'Are you sure you want to cancel this session?']);
            endif;?>
        </div>
    </div>
</div>
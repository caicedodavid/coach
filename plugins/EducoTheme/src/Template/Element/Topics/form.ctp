            ...
            <div class="tab-content">
                ...
                <div class="loading" aria-label="Loading" role="img" tabindex="-1"></div>
                        <div class="row">
                            ...
                            <?php
                                echo $this->Form->input('name', ['class' => 'form-control topic-input']);
                            ...
                            <?php            
                                echo $this->Form->input('duration', ['options' => $times, 'class' => 'form-control duration-select topic-input', 'empty' => __('Select...')]);

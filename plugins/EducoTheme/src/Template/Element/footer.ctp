            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="widget text-widget">
                        <p>
                            <?= $this->Html->link($this->Html->image('footer/F_Logo.png', ['alt' => 'Footer Logo', 'pathPrefix' => 'images/']), '/', ['escape' => false])?>
                        </p>
                ...
                <div class="col-lg-4 col-md-4 col-sm-12">
                    <div class="widget text-widget">
                        ...
                        <p><i class="fa fa-envelope-o"></i><a href="#">info@edutioncollege.gov.co.uk</a> <a href="#">public@edutioncollege.gov.co.uk</a>
                        </p>
